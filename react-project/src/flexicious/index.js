  ...
  PrintExportOptions,
     ...
     */
     UIUtils.resolveExpression=(
      ...
      if (typeof returnUndefinedIfPropertyNotFound == "undefined") returnUndefinedIfPropertyNotFound = false;
      ...
      if (!UIUtils.expressionCache[expression]) {
          ...
          UIUtils.expressionCache[expression].isSimple = !expression.includes(".") && !expression.includes("[");
      }
      ...
      if (UIUtils.expressionCache[expression].isSimple) {
          ...
          if (valueToApply != null || applyNullValues) {
              if (valueApplier)
                  ...
                  host[expression] = valueToApply;
          }
          const result = UIUtils.checkGetterAndRetrieve(host, expression);
          return (typeof result !== 'undefined' && result !== null) ? result : returnUndefinedIfPropertyNotFound ? undefined : null;
      }
      ...
      for ( i = 0; i < fields.length; i++) {
          ...
          if (field.includes("[")) {
              const indexString = field.substring(field.indexOf("[") + 1, field.indexOf("]"));

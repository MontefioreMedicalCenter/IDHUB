...
})((props) => <Tabs  {...props} textColor="primary" TabIndicatorProps={{ children: <div /> }} />);
        ...
        <div className={classes.root}>
            <div className={classes.demo}>
                <StyledTabs
                    ...
                    value={history.location.pathname} onChange={handleCallToRouter} aria-label="styled tabs example">
                    {

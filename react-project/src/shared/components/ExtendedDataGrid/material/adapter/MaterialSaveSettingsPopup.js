...
export default class MaterialSaveSettingsPopup extends UIComponent {
    ...
    const actions = [
      ToolbarAction.create(
        this.grid.enableMultiplePreferences
          ? Constants.SAVE_SETTINGS_REMOVE_ALL_SAVED_PREFERENCES
          : Constants.SAVE_SETTINGS_CLEAR_SAVED_PREFERENCES,
        this.onClearSettings.bind(this),
        true,
      ),
      ToolbarAction.create(
        Constants.SAVE_SETTINGS_SAVE_PREFERENCES,
        this.onSaveSettings.bind(this),
        true,
      ),
      ToolbarAction.create(
        Constants.SAVE_SETTINGS_CANCEL,
  ...
  setGrid(val) {
    ...
    this.preferenceName = this.grid.getCurrentPreferenceInfo()
      ? grid.getCurrentPreferenceInfo().name
      : "Default";
    this.preferenceIsDefault = this.grid.getCurrentPreferenceInfo()
      ? grid.getCurrentPreferenceInfo().name ===
        grid.getGridPreferencesInfo().defaultPreferenceName
      : "Default";
  }
  ...
  onSaveSettings(domElementdiv) {
    ...
    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_COLUMN_ORDER")
        .checked
    )
      preferencesToPersist.push(Constants.PERSIST_COLUMN_ORDER);
    if (
      UIUtils.findElementWithClassName(
        domElementdiv,
        "cbPERSIST_COLUMN_VISIBILITY",
      ).checked
    )
      preferencesToPersist.push(Constants.PERSIST_COLUMN_VISIBILITY);
    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_COLUMN_WIDTH")
        .checked
    )
      preferencesToPersist.push(Constants.PERSIST_COLUMN_WIDTH);
    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_FILTER")
        .checked
    )
      preferencesToPersist.push(Constants.PERSIST_FILTER);
    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_SORT").checked
    )
      preferencesToPersist.push(Constants.PERSIST_SORT);
    if (
      UIUtils.findElementWithClassName(
        domElementdiv,
        "cbPERSIST_FOOTER_FILTER_VISIBILITY",
      ).checked
    )
      preferencesToPersist.push(Constants.PERSIST_FOOTER_FILTER_VISIBILITY);
    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_PAGE_SIZE")
        .checked
    )
    ...
    if (
      UIUtils.findElementWithClassName(
        domElementdiv,
        "cbPERSIST_PRINT_SETTINGS",
      ).checked
    )
      preferencesToPersist.push(Constants.PERSIST_PRINT_SETTINGS);

    if (
      UIUtils.findElementWithClassName(domElementdiv, "cbPERSIST_SCROLL")
        .checked
    ) {
    ...
    if (this.grid.enableMultiplePreferences)
      this.grid.persistPreferences(
        UIUtils.findElementWithClassName(domElementdiv, "txtPreferenceName")
          .value,
        UIUtils.findElementWithClassName(domElementdiv, "cbDefaultPreference")
          .checked,
      );
  ...
  render() {
    const prefName =
      "The preferences you specify below will be retained when this grid is loaded in the future:";
      ...
      return (
        <div>
          <div style={{ float: "left" }}>
            ...
            <input
              className={"txtPreferenceName"}
              value={this.preferenceName}
            />
            <Checkbox
              className={"cbDefaultPreference"}
              defaultChecked={this.preferenceIsDefault}
            >
              {" "}
              Is Default?
            </Checkbox>
                  ...
                  <FormControl>
                    <FormGroup>
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_COLUMN_ORDER"}
                            defaultChecked={true}
                          />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_COLUMN_VISIBILITY"}
                            defaultChecked={true}
                          />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_COLUMN_WIDTH"}
                            defaultChecked={true}
                          />
                        }
                  ...
                  <FormControl>
                    <FormGroup>
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_FOOTER_FILTER_VISIBILITY"}
                            defaultChecked={true}
                          />
                        }
                        label={
                          Constants.SAVE_SETTINGS_FILTER_AND_FOOTER_VISIBILITY
                        }
                      />
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_PAGE_SIZE"}
                            defaultChecked={true}
                          />
                        }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            className={"cbPERSIST_PRINT_SETTINGS"}
                            defaultChecked={true}
                          />
                        }
 ...
 * @type {Function}
 * */
MaterialSaveSettingsPopup.prototype.typeName = MaterialSaveSettingsPopup.typeName =
  "MaterialSaveSettingsPopup"; //for quick inspection
